...
This project is an automated test suite for the [OrangeHRM](https://www.orangehrm.com/) web application, built using **Robot Framework** and **SeleniumLibrary**.It covers key user flows such as login, forgot password, and other HRM functionalities.  
